...
module Zipstream
  ...
  class StaticFileHandler
    ...
    def initialize(public_dir : String, @fallthrough : Bool = true, @directory_listing : Bool = true, @match_hidden = false, @follow_symlinks = false)
    ...
    private def check_request_path!(context : HTTP::Server::Context, request_path : String) : Bool
    ...
    private def serve_file_range(context : HTTP::Server::Context, file : File, range_header : String, file_info)
    ...
    private def serve_file_full(context : HTTP::Server::Context, file : File, file_info)
      context.response.status = :ok
    ...
    private def request_path(context : HTTP::Server::Context) : String
